...
class App extends React.Component {
  ...
  getFormValues(item) {
    ...
    let research_area = $(`#change_${item.id} input[name='research_area']`).val();
    if (!id) {
      id = item.id;
    }
    if (!name) {
                ...
                this.state.data.map(item => {
                  return (<tbody key={item.id}>
                    <tr id={`display_${item.id}`}>
                      ...
                      <td>
                        <font face="Verdana">{
                            item.profession_title.map((pt_item) => {
                              return (<span>{pt_item}
                              </span>)
                            })
                          }</font>
                    ...
                    <tr id={`change_${item.id}`} style={{
                      ...
                      <td>
                        <MultiSelect name="profession_title" handleSelect={(selectedOptions) => {
